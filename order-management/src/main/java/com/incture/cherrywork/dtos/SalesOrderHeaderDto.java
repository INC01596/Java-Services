	...
	//sandeep
		...
		public String toString() {
			return "SalesOrderHeaderDto [clientSpecific=" + clientSpecific + ", s4DocumentId=" + s4DocumentId
					...
					+ overallDocumentStatus + ", deliveryStatus=" + deliveryStatus + ", deliveryTolerance="
					+ deliveryTolerance + ", colorCoding=" + colorCoding + ", comments=" + comments + ", bankName="
					+ bankName + ", projectName=" + projectName + ", poTypeField=" + poTypeField + ", pieceGuarantee="
					+ pieceGuarantee + ", acknowledgementStatus=" + acknowledgementStatus + ", updateIndicator="
					+ updateIndicator + ", lastUpdatedOn=" + lastUpdatedOn + ", syncStatus=" + syncStatus
					+ ", createdBy=" + createdBy + ", createdOn=" + createdOn + ", lastChangedBy=" + lastChangedBy
					+ ", lastChangedOn=" + lastChangedOn + ", salesOrderItemList=" + salesOrderItemList
					+ ", salesHeaderId=" + salesHeaderId + ", plant=" + plant + ", netValueSA=" + netValueSA
					+ ", totalSalesOrderQuantitySA=" + totalSalesOrderQuantitySA + ", totalSalesOrderQuantity="
					...
					+ referenceDocument + ", name=" + name + ", emailId=" + emailId + ", city=" + city
					+ ", destCountry=" + destCountry + ", contactNo=" + contactNo + ", paymentTerms=" + paymentTerms
					+ ", incoTerms1=" + incoTerms1 + ", incoTerms2=" + incoTerms2 + ", weight=" + weight + ", country="
					+ country + ", orderReason=" + orderReason + ", overDeliveryTolerance=" + overDeliveryTolerance
					+ ", underDeliveryTolerance=" + underDeliveryTolerance + ", colorCodingDetails="
					+ colorCodingDetails + ", postingDate=" + postingDate + ", postingError=" + postingError
					+ ", postingStatus=" + postingStatus + ", documentProcessStatus=" + documentProcessStatus + "]";
		}
