...
public class SalesOrderHeaderDto {
	...
	//Awadhesh Kumar ------------------------------------------------------
		...
		private java.util.Date customerPODate;

		public java.util.Date getCustomerPODate() {
			return customerPODate;
		}

		public void setCustomerPODate(java.util.Date customerPODate) {
			this.customerPODate = customerPODate;
		}
	...
	//sandeep
		...
		public String toString() {
			return "SalesOrderHeaderDto [tableKey=" + tableKey + /*", actualDeliveryDate=" + actualDeliveryDate
					+ ", additionalDataSelection=" + additionalDataSelection + ", assignment=" + assignment
					+ ", availabilityStatus=" + availabilityStatus +*/ ", acknowledgementStatus=" + acknowledgementStatus
					+ ", bankName=" + bankName + /*", BlockedStatus=" + BlockedStatus + ", checkeoutStatus=" + checkeoutStatus
					+ */", city=" + city + ", clientSpecific=" + clientSpecific + ", colorCodingDetails=" + colorCodingDetails
					+ ", comments=" + comments + ", country=" + country + /*", container=" + container + */", destCountry="
					+ destCountry + ", contactNo=" + contactNo + ", createdBy=" + createdBy + ", createdDate=" + createdDate
					+ /*", creditBlockQuantity=" + creditBlockQuantity + ", creditExceedAmount=" + creditExceedAmount
					+ ", creditExposure=" + creditExposure + */", customerPODate=" + customerPODate + ", customerPONum="
					+ customerPONum + /*", customerTelephoneNumber=" + customerTelephoneNumber + ", deliveryLeadingDays="
					+ deliveryLeadingDays + */", deliveryStatus=" + deliveryStatus + ", deliveryTolerance="
					+ deliveryTolerance + ", overDeliveryTolerance=" + overDeliveryTolerance + ", underDeliveryTolerance="
					+ underDeliveryTolerance + /*", description=" + description + */", distributionChannel="
					+ distributionChannel + ", division=" + division + ", documentCurrency=" + documentCurrency
					+ ", documentCurrencySA=" + documentCurrencySA + ", documentProcessStatus=" + documentProcessStatus
					+ /*", documentReceivedDate=" + documentReceivedDate +*/ ", documentType=" + documentType
					+ ", documentCategory=" + documentCategory + ", deliveredQuantity=" + deliveredQuantity
					+ /*", onTimeDeliveredQuantity=" + onTimeDeliveredQuantity + */", emailId=" + emailId + ", incoTerms1="
					+ incoTerms1 + ", incoTerms2=" + incoTerms2 + /*", isCustomerAcknowledgement=" + isCustomerAcknowledgement
					+ ", isOpen=" + isOpen + ", isSyndicated=" + isSyndicated + ", lastUpdatedBy=" + lastUpdatedBy
					+ */", lastUpdatedOn=" + lastUpdatedOn + /*", materialAvailableDate=" + materialAvailableDate + */", name="
					+ name + ", netValue=" + netValue + ", netValueSA=" + netValueSA + ", orderReason=" + orderReason
					+ ", outstandingQuantity=" + outstandingQuantity + ", overallDocumentStatus=" + overallDocumentStatus
					+ /*", paymentChequeDetail=" + paymentChequeDetail + ", paymentLeadingDays=" + paymentLeadingDays
					+ */", paymentTerms=" + paymentTerms + /*", paymentStatus=" + paymentStatus + */", pieceGuarantee="
					+ pieceGuarantee + ", plant=" + plant + ", poTypeField=" + poTypeField + ", postingDate=" + postingDate
					+ ", postingError=" + postingError + /*", postedFrom=" + postedFrom + */", postingStatus=" + postingStatus
					+ ", projectName=" + projectName + ", referenceDocument=" + referenceDocument + /*", releasedDate="
					+ releasedDate + */", requestDeliveryDate=" + requestDeliveryDate + ", s4DocumentId=" + s4DocumentId
					+ ", salesGroup=" + salesGroup + ", salesHeaderId=" + salesHeaderId + ", salesOffice=" + salesOffice
					+ /*", salesOrganization=" + salesOrganization + ", salesRepresentative=" + salesRepresentative
					+ */", shipToParty=" + shipToParty + /*", shipptingAddress=" + shipptingAddress + ", shippingInstructions="
					+ shippingInstructions + */", shippingType=" + shippingType + ", soldToParty=" + soldToParty
					+ ", syncStatus=" + syncStatus + ", totalSalesOrderQuantity=" + totalSalesOrderQuantity
					+ ", totalSalesOrderQuantitySA=" + totalSalesOrderQuantitySA + ", updateIndicator=" + updateIndicator
					+ /*", validFrom=" + validFrom + ", validTo=" + validTo + */", weight=" + weight + /*", workflowID="
					+ workflowID + */"]";
		}
