...
public class AbbyySchedulerLogsDto {
	...
	public AbbyySchedulerLogsDto() {
		super();
	}

	public AbbyySchedulerLogsDto(String loggedMessage, String timeStamp, LocalDateTime istTimeStamp) {
		super();
		this.loggedMessage = loggedMessage;
		this.timeStamp = timeStamp;
		this.istTimeStamp = istTimeStamp;
