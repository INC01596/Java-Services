...
//@Api(value = "Document Store", tags = { "Document Store" }, description = "  ")
...
//	// }
//
//	@PostMapping("/shareUpload")
//	@ApiOperation(value = "Upload document ")
//	public ResponseDto uploadFileToShare(@ApiParam(value = "Entity ID") @RequestParam("entityId") String entityId,
//			@ApiParam(value = "Entity Type") @RequestParam("entityType") String entityType,
//			@RequestParam CommonsMultipartFile files) throws IOException, FileUploadException {
//
//		return documentModelService.uploadDocument(entityId, entityType, files);
//
//	}
