...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.SalesOrderDto.class, columns = {
...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.ItemStatusTrackingLevelMsgDto.class, columns = {
...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.SalesOrderTaskStatusDto.class, columns = {
...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.SalesOrderItemStatusDto.class, columns = {
...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.SupportUserFunctionTaskItemDataDto.class, columns = {
...
//		@ConstructorResult(targetClass = com.incture.return_management.dto.SalesOrderLevelStatusDto.class, columns = {
