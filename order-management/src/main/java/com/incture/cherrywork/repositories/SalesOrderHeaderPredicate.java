...
public class SalesOrderHeaderPredicate{

private SearchCriteria criteria;

public SalesOrderHeaderPredicate(final SearchCriteria criteria) {
this.criteria = criteria;
}

public BooleanExpression getPredicate() {
final PathBuilder<SalesOrderHeader> entityPath = new PathBuilder<>(SalesOrderHeader.class, "salesOrderHeader");
