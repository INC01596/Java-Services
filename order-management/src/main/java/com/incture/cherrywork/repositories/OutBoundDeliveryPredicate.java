...
public class OutBoundDeliveryPredicate {
	
	private SearchCriteria criteria;

	public OutBoundDeliveryPredicate(final SearchCriteria criteria) {
	this.criteria = criteria;
	}

	public BooleanExpression getPredicate() {
	final PathBuilder<OutBoundDelivery> entityPath = new PathBuilder<>(OutBoundDelivery.class, "OutBoundDelivery");
