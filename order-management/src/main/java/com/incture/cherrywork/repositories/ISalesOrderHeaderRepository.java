...
public interface ISalesOrderHeaderRepository extends JpaRepository<SalesOrderHeader, String>,
	...
	public Page<SalesOrderHeader> findAll(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("documentProcessStatus")List <EnOrderActionStatus> documentProcessStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
	...
	public Page<SalesOrderHeader> findAll12(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
//    
	...
	public Page<SalesOrderHeader> findAll(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("documentProcessStatus") List<EnOrderActionStatus> documentProcessStatus,Pageable pageable);
	//type=sTpId
	
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId  order by s.postingDate desc ")
	public Page<SalesOrderHeader> findAll123(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,Pageable pageable);
...
//<---------------------------------------------------------------------------------------------------------------->
	...
	public Page<SalesOrderHeader> findAll(@Param("documentType") String documentType,@Param("documentProcessStatus") List<EnOrderActionStatus> documentProcessStatus,Pageable pageable);
...
//	//status+createdDate+doctype
	...
	public Page<SalesOrderHeader> findAll(@Param("documentType") String documentType,@Param("documentProcessStatus") List<EnOrderActionStatus> documentProcessStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
// 
...
//	//Status+shipToParty
	...
	public Page<SalesOrderHeader> findAll1(@Param("documentType") String documentType,@Param("documentProcessStatus") List<EnOrderActionStatus> documentProcessStatus,@Param("shipToParty") String shipToParty,Pageable pageable); 
//    
//	
...
//	//status+createddate+deliveryDate
	...
	public Page<SalesOrderHeader> findAll(@Param("documentType") String documentType,@Param("documentProcessStatus") List<EnOrderActionStatus> documentProcessStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,@Param("shipToParty") String shipToParty,Pageable pageable); 
//    
//	
