...
=======
      @Query("from SalesOrderHeader s where  s.invId=:invId order by s.createdDate desc")
	   public Page<SalesOrderHeader> findAllInvId(@Param("invId") String invId,Pageable pageable);
...
=======
     ...
     //salesHeaderId
		@Query("from SalesOrderHeader s where s.salesHeaderId=:salesHeaderId and s.invoiceStatus='CREATED' order by s.createdDate desc")
		public Page<SalesOrderHeader> findAllS(@Param("salesHeaderId") String salesHeaderId,Pageable pageable);
	
		@Query("from SalesOrderHeader s where s.salesHeaderId=:salesHeaderId and s.documentType=:documentType order by s.createdDate desc")
>>>>>>> 7d779a97118c12d1811378be9f7c83fdeaf836f0
		public Page<SalesOrderHeader> findAllS1(@Param("salesHeaderId") String salesHeaderId,@Param("documentType") String documentType,Pageable pageable);
	...
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId and s.documentProcessStatus=:documentProcessStatus and s.createdDate between :stDate and :enDate order by s.postingDate desc")
...
//    
	...
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId  and s.documentProcessStatus=:documentProcessStatus order by s.postingDate desc ")
...
//<---------------------------------------------------------------------------------------------------------------->
	...
	//documentType+Status	
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.documentProcessStatus=:documentProcessStatus order by s.postingDate desc")
...
//	//status+createdDate+doctype
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.documentProcessStatus=:documentProcessStatus and s.createdDate between :stDate and :enDate order by s.postingDate desc")
...
//	<------------------------------------------------------------------------------------------------------------------------->
//	//Status+shipToParty
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.documentProcessStatus=:documentProcessStatus and s.shipToParty=:shipToParty order by s.postingDate desc" )
...
//	//status+createddate+deliveryDate
	@Query("from SalesOrderHeader s where s.documentType=:documentType and s.documentProcessStatus=:documentProcessStatus and s.createdDate between :stDate and :enDate and s.shipToParty=:shipToParty order by s.postingDate desc")
...
<<<<<<< HEAD
		...
		public Page<SalesOrderHeader> findAllInv1(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("invoiceStatus") String invoiceStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
		...
		public Page<SalesOrderHeader> findAllInv2(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("invoiceStatus") String invoiceStatus,Pageable pageable);
		...
		public Page<SalesOrderHeader> findAllInv3(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,Pageable pageable);
		...
		public Page<SalesOrderHeader> findAllInv4(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
	// 
		//Status+shipToParty
...
=======
		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId and s.invoiceStatus=:invoiceStatus and s.createdDate between :stDate and :enDate order by s.createdDate desc")
		public Page<SalesOrderHeader> findAllInv1(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("invoiceStatus") String invoiceStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
	    
		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId  and s.invoiceStatus=:invoiceStatus order by s.createdDate desc ")
		public Page<SalesOrderHeader> findAllInv2(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("invoiceStatus") String invoiceStatus,Pageable pageable);
	
		//documentType+Status	
		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.invoiceStatus=:invoiceStatus order by s.createdDate desc")
		public Page<SalesOrderHeader> findAllInv3(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,Pageable pageable);

		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.invoiceStatus=:invoiceStatus and s.createdDate between :stDate and :enDate order by s.createdDate desc")
		public Page<SalesOrderHeader> findAllInv4(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
	// 
		//Status+shipToParty
		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.invoiceStatus=:invoiceStatus and s.shipToParty=:shipToParty order by s.createdDate desc" )
>>>>>>> 7d779a97118c12d1811378be9f7c83fdeaf836f0
		public Page<SalesOrderHeader> findAllInv5(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,@Param("shipToParty") String shipToParty,Pageable pageable); 
	//   
...
=======
		@Query("from SalesOrderHeader s where s.documentType=:documentType and s.invoiceStatus=:invoiceStatus and s.createdDate between :stDate and :enDate and s.shipToParty=:shipToParty order by s.createdDate desc")
>>>>>>> 7d779a97118c12d1811378be9f7c83fdeaf836f0
		public Page<SalesOrderHeader> findAllInv6(@Param("documentType") String documentType,@Param("invoiceStatus") String invoiceStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,@Param("shipToParty") String shipToParty,Pageable pageable); 
	//    
		//<----------------------------------------------------------------------------------------------->
...
<<<<<<< HEAD
				...
				public Page<SalesOrderHeader> findAllObd1(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
				...
				public Page<SalesOrderHeader> findAllObd2(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("obdStatus") String obdStatus,Pageable pageable);
			
				//documentType+Status	
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus=:obdStatus order by s.postingDate desc")
				public Page<SalesOrderHeader> findAllObd3(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,Pageable pageable);
				...
				public Page<SalesOrderHeader> findAllObd4(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
			// 
				//Status+shipToParty
...
=======
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId and s.obdStatus=:obdStatus and s.createdDate between :stDate and :enDate order by s.createdDate desc")
				public Page<SalesOrderHeader> findAllObd1(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
			    
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.soldToParty in :stpId  and s.obdStatus=:obdStatus order by s.createdDate desc ")
				public Page<SalesOrderHeader> findAllObd2(@Param("documentType") String documentType,@Param("stpId") List<String> stpId,@Param("obdStatus") String obdStatus,Pageable pageable);
			
				//documentType+Status	
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus=:obdStatus order by s.createdDate desc")
				public Page<SalesOrderHeader> findAllObd3(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,Pageable pageable);

				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus=:obdStatus and s.createdDate between :stDate and :enDate order by s.createdDate desc")
				public Page<SalesOrderHeader> findAllObd4(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,Pageable pageable); 
			// 
				//Status+shipToParty
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus=:obdStatus and s.shipToParty=:shipToParty order by s.createdDate desc" )
>>>>>>> 7d779a97118c12d1811378be9f7c83fdeaf836f0
				public Page<SalesOrderHeader> findAllObd5(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,@Param("shipToParty") String shipToParty,Pageable pageable); 
			//   
...
<<<<<<< HEAD
				...
				public Page<SalesOrderHeader> findAllObd6(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,@Param("shipToParty") String shipToParty,Pageable pageable); 
			//    
...
=======
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus=:obdStatus and s.createdDate between :stDate and :enDate and s.shipToParty=:shipToParty order by s.createdDate desc")
				public Page<SalesOrderHeader> findAllObd6(@Param("documentType") String documentType,@Param("obdStatus") String obdStatus,@Param("stDate") Date stDate,@Param("enDate") Date enDate,@Param("shipToParty") String shipToParty,Pageable pageable); 
			//    
				@Query("from SalesOrderHeader s where s.documentType=:documentType and s.obdStatus='CREATED' and s.pgiStatus='CREATED' and s.invoiceStatus in :invoiceStatus order by s.createdDate desc")
>>>>>>> 7d779a97118c12d1811378be9f7c83fdeaf836f0
				public Page<SalesOrderHeader> findAllOPI(@Param("documentType") String documentType,@Param("invoiceStatus") List<String>invoiceStatus, Pageable pageable); 
			//    
}
