...
public class OutBoundDeliveryItemPredicate {
	
	private SearchCriteria criteria;
	
	public OutBoundDeliveryItemPredicate(final SearchCriteria criteria) {
		this.criteria = criteria;
		}
	public BooleanExpression getPredicate() {
		final PathBuilder<OutBoundDeliveryItem> entityPath = new PathBuilder<>(OutBoundDeliveryItem.class, "outBoundDeliveryItem");
