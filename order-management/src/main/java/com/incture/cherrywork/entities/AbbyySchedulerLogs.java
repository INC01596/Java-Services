...
@Table(name = "Abbyy_Scheduler_Logs")
@Entity
public class AbbyySchedulerLogs {
	...
	public AbbyySchedulerLogs(String id, String loggedMessage, String timeStamp, LocalDateTime istTimeStamp) {
		super();
		this.id = id;
		this.loggedMessage = loggedMessage;
		this.timeStamp = timeStamp;
	...
	public AbbyySchedulerLogs() {
		super();
	}

	@Override
	public String toString() {
		return "AbbyySchedulerLogs [id=" + id + ", loggedMessage=" + loggedMessage + ", timeStamp=" + timeStamp
